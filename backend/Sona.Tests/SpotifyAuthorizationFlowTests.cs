...
public class SpotifyAuthorizationFlowTests
{
    ...
    private static HttpResponseMessage PlaylistDetailsResponse(string playlistId = "playlist-id", string snapshotId = "snapshot")
    {
        return JsonResponse(HttpStatusCode.OK, $$"""
            {
              "collaborative": false,
    ...
    private static string TrackItemJson(string name, string id)
    {
        return $$"""
            {
              "added_at": "2026-06-20T09:00:00Z",
